                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                ...
                                <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                                    <th scope="row" class="items-center px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    ...
                                    <td class="px-4 py-2">
                                        <span class="inline-flex items-center rounded-md font-bold px-2 py-1 text-sm me-2 dark:bg-slate-800 text-indigo-600 ring-1 ring-inset ring-indigo-700">
                                            <span class="flex w-1.5 h-1.5 bg-indigo-600 rounded-full"></span>
                                             En curso
                                        </span>
                                    </td>
                                    <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    ...
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        <a href="{{route('quotes_company.upload', $quote->id)}}" type="button" class="px-2 py-1 mr-1 text-xs font-medium text-center inline-flex items-center text-white bg-blue-600 rounded-lg hover:bg-blue-400 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                            <svg class="w-4 h-5 fill-[#ffffff]" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <a href="{{route('quotes_company.pdf', $quote->id)}}" type="button" class="px-2 py-1 mr-1 text-xs font-medium text-center inline-flex items-center text-white bg-red-600 rounded-lg hover:bg-red-400 focus:ring-4 focus:outline-none focus:ring-red-300 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">
                                             <svg class="w-4 h-5 text-white-800 dark:text-white fill-[#ffff]" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                                                <!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                        ...
                                        <a href="{{route('quotes_company.edit', $quote->id)}}" type="button" class="px-2 py-1 text-xs font-medium text-center inline-flex items-center text-white bg-yellow-600 rounded-lg hover:bg-yellow-400 focus:ring-4 focus:outline-none focus:ring-yellow-300 dark:bg-yellow-600 dark:hover:bg-yellow-700 dark:focus:ring-yellow-800">
